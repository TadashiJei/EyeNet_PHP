...
('check_timeout', '5'),
('company_details', ''),
('company_name', 'EyeNet Company'),
('date_format', 'Y-m-d;yyyy-mm-dd'),
('db_version', '1.12'),
('default_contacts', 'a:1:{i:0;s:1:"1";}'),
('default_lang', 'en'),
('email_from_address', 'EyeNet@example.com'),
('email_from_name', 'EyeNet'),
...
(3, 'EyeNet Incident Alert', '{subject}', '<p>Hello {contact},</p><p><b>{message}</b></p><p><br>Best regards,<br>{company}<br></p>', '');

INSERT INTO `core_notifications` (`id`, `name`, `subject`, `message`, `info`) VALUES (4, 'EyeNet Incident Unresolved', '{subject}', '<p>Hello {contact},</p><p><b>{message}</b></p><p><br>Best regards,<br>{company}<br></p>', '');
